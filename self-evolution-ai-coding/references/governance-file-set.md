...
- AI 员工、提示词、记忆和 skill 的边界优先写入项目开发手册；只有多项目通用规则才进入全局 reference。
...
- `digital-employee-runtime.md`：数字员工与数字生命运行时。
- `prompt-skill-boundary.md`：skill、prompt、memory 和场景专家边界。
